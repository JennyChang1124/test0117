...
import kotlinx.android.synthetic.main.mainn.*
import kotlinx.android.synthetic.main.toolbar.*


class Main_logActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navigation.setNavigationItemSelectedListener {
            it.isChecked=true
            when(it.itemId){
                R.id.id_home_fragment->replaceFragment(Home_Fragment(),it.title.toString())
